  ...
  return (
    <nav className="bg-blue-900 w-full h-full flex items-center justify-center flex-col overflow-hidden">
      ...
      <div className="flex items-center flex-shrink-0 text-white mr-6">
        <Link to="/" className="font-semibold text-xl tracking-tight"><img src="http://localhost:5173/public/logo.jpeg" alt="" className='h-10 w-10 flex items-center rounded-lg object-cover' /></Link>
      </div>
